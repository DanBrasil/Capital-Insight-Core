...
const dashboard_period_dto_1 = require("./dto/dashboard-period.dto");
...
let DashboardController = class DashboardController {
    ...
    async getChart(user, query) {
        return this.dashboardService.getChart(user.tenantId, user.id, query.period);
    }
    async getRecentTransactions(user, query) {
        return this.dashboardService.getRecentTransactions(user.tenantId, user.id, query.period);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, dashboard_period_dto_1.DashboardPeriodDto]),
